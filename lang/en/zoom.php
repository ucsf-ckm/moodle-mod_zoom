...
$string['host'] = 'Host';
$string['hostintro'] = 'When you create this meeting, you become the host of the meeting and are the only one who is allowed to start the meeting. Other users, regardless if they have the teacher role in this course or not, cannot start the meeting. To overcome this restriction and to empower other users to start the meeting, you can use the following {$a->mechanism}:';
$string['hostintromechanism'] = 'mechanism';
$string['hostintromechanisms'] = 'mechanisms';
...
$string['zoomerr_alternativehostusernotfound'] = 'User {$a->alternativehost} was not found on Zoom.';
